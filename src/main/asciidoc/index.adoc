...
If you want to fallback to the original xml configuration you can provide `ignite.xml` file on your classpath
and this will be used instead. Note: You need to add back the `ignite-spring` module to your classpath.
