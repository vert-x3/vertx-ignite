...
As an alternative to the json format you can use the native ignite xml configuration. You can provide `ignite.xml` file
on your classpath and it will be used instead. Note: You need to add back the `ignite-spring` module to your classpath.

Add the ignite-spring dependency.
...
* Example for a default xml config:
