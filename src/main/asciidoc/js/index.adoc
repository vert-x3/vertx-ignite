...
`vertx-ignite-3.5.1-SNAPSHOT.jar` should be in the `lib` directory of the Vert.x installation.
...
----
compile 'io.vertx:vertx-ignite:3.5.1-SNAPSHOT'
----
...
If using Vert.x programmatically you can specify this using `link:../../vertx-core/dataobjects.html#VertxOptions#setClusterHost[clusterHost]`.
